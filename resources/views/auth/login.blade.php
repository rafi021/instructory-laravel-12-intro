...
@section('main-content')
    <div class="flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-50 to-blue-100">
        <div
            ...
            <h2 class="text-3xl font-extrabold mb-8 text-center text-gray-700 tracking-tight">Login Form</h2>
            ...
            <div class="mt-6 text-center text-gray-600">
                ...
                <a href="{{ route('register.form') }}" class="text-teal-600 hover:underline font-semibold">Register</a>
            </div>
        </div>
    </div>
@endsection
