                    ...
                    <tbody class="divide-y divide-gray-100">
                        @forelse ($tasks as $task)
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-6 py-4">
                                    @if ($task->image == null)
                                        <img src="https://placehold.co/400" alt="" class="w-12 h-12 object-cover rounded-full border-2 border-indigo-200 shadow">
                                    @else
                                ...
                                <td class="px-6 py-4 text-sm text-gray-600">{{ \Carbon\Carbon::parse($task->date)->format('M d, Y') }}</td>
                                <td class="px-6 py-4">
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="px-6 py-8 text-center text-gray-400 text-lg">
                                    No tasks found. <a href="{{ route('tasks.create') }}" class="text-indigo-600 underline">Create one?</a>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
